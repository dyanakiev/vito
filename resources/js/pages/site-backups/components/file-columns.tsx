...
import RestoreSiteBackup from '@/pages/site-backups/components/restore-site-backup';
...
function Delete({ file, onDeleted }: { file: BackupFile; onDeleted?: (file: BackupFile) => void }) {
  ...
  const submit = () => {
    form.delete(
      route('site-backup-files.destroy', {
        ...
        <div className="flex items-center justify-end">
          <DropdownMenu modal={false}>
            ...
            <DropdownMenuContent align="end">
              <RestoreSiteBackup backup={row.original.backup} file={row.original}>
